...
def soustraire_spectre(wn_echantillon, intensite_echantillon, 
                        ...
                        ordre_baseline=10, fenetres_fit=None):
    """
...
plt.plot(w, i, linewidth=0.8, label='petri 1 zone 1')
plt.plot(w_p, i_p, linewidth=0.8, label='spectre du pétri')
plt.plot(w, i_corr+0.5, linewidth=0.8, label='spectre corrigé')
plt.legend()
plt.show()
