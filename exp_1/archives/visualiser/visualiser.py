...
ax1.plot(w_j4s4p1, i_j4s4p1 +10 , 'r-', label='jour 4')
ax1.plot(w_j8s4p4, i_j8s4p4+20, 'g-', label='jour 8')
ax1.plot(w_j11s4p3, i_j11s4p3+30, 'c-', label='jour 11')
ax1.set_title('Spectre raman souris 4 irradiée 60 Gy')
ax2.plot(w_j2s5p4, i_j2s5p4, 'b-', label='jour 2')
ax2.plot(w_j4s5p1, i_j4s5p1+10, 'r-', label='jour 4')
ax2.plot(w_j8s5p4, i_j8s5p4+20, 'g-', label='jour 8')
ax2.plot(w_j11s5p3, i_j11s5p3+30, 'c-', label='jour 11')
